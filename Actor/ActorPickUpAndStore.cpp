...
#include "ActorPickUpAndStore.h"
#include "Components/StaticMeshComponent.h"
#include "Components/BoxComponent.h"


// Sets default values
AActorPickUpAndStore::AActorPickUpAndStore()
{
...
void AActorPickUpAndStore::OnInteract()
{
...
void AActorPickUpAndStore::OnBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
...
void AActorPickUpAndStore::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AActorPickUpAndStore::Tick(float DeltaTime)
{
